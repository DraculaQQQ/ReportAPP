...
public class HttpFileUpload implements Runnable{
    ...
    HttpFileUpload(String urlString, String vTitle, String vDesc,String vIssuer, String vSubject, String vLocation){
        try{
    ...
    void Sending(){
        ...
        String iFileName = "JPEG_" + timeStamp + ".jpg";
        String lineEnd = "\r\n";
        String twoHyphens = "--";
        String boundary = "*****";
        String Tag="fSnd";
        try
        {
            ...
            dos.writeBytes(twoHyphens + boundary + lineEnd);
            dos.writeBytes("Content-Disposition: form-data; name=\"issuer\""+ lineEnd);
            dos.writeBytes(lineEnd);
            dos.writeBytes(Issuer);
            dos.writeBytes(lineEnd);
            dos.writeBytes(twoHyphens + boundary + lineEnd);
